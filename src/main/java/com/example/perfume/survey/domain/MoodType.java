...
public enum MoodType {
    //따뜻한
    WARMTH("따뜻한",
            "따뜻하고 온화한 분위기를 연출하고 싶군요. 이 향수를 사용하시면 추운 겨울에도 따뜻한 분위기를 낼 수 있을거에요. 또 겉으로는 시크하지만 내면은 따뜻한 무드를 가지고 있음을 잘 나타내줄 거에요."),
    //산뜻한
    ...
    //포근한
    COZY("포근한",
            "포근한 분위기를 좋아하시군요. 이 향수로 꽃들 사이로 살포시 내려앉은 햇살같은 포근한 분위기를 연출할 수 있을거에요. 멋들어지거나 화려하지는 않지만, 가만히 안기고 싶은 포근한 매력을 가지고 있어요."),
    //세련된
    ...
    //싱그러운
    REFRESHING("싱그러운",
            "예쁜 정원에 있는 듯한 싱그러운 분위기를 좋아하시군요. 생동감 있고 프레쉬한 경쾌함을 느끼고 싶을 때 사용해보세요. 또 힘이 없는 날에 사용하신다면 지친 심신에 큰 활력이 될거에요.");
