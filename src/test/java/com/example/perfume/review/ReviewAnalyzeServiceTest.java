...
public class ReviewAnalyzeServiceTest {
    ...
    void sortLikeReview() {
        ...
        when(reviewBoardRepository.findAllByOrderByLikeCountDesc()).thenReturn(mockReviewBoard);
    ...
    void sortUnLikeReview() {
        ...
        when(reviewBoardRepository.findAllByOrderByUnlikeCountDesc()).thenReturn(mockReviewBoard);
